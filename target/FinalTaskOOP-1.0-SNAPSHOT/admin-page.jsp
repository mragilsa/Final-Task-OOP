...
<%
    ...
    try {
        Connection conn = DatabaseConnection.getConnection(); // ✅ ambil koneksi DB
        BookDAO dao = new BookDAO(conn);                      // ✅ buat DAO dengan koneksi
        books = dao.getAllBooks();                            // ✅ ambil data buku
    ...
    <body>
        ...
        <main>
            ...
            <div class="button-group">
                ...
                <a href="view-transactions.jsp" class="btn btn-success">View Transaction</a>
