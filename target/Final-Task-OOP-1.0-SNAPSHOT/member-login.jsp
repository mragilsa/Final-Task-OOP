    ...
    <div class="min-h-screen grid md:grid-cols-2">
        ...
        <div class="bg-blue-600 text-white flex flex-col justify-center px-12 py-20">
            ...
            <p class="text-lg font-medium leading-relaxed">
                Welcome to the digital library management system. Login as a member to access the book collection and your borrowing history.
            </p>
        ...
        <div class="flex flex-col justify-center px-6 sm:px-12 py-12">
            <h2 class="text-3xl font-bold mb-6 text-gray-800 text-center">Member Login</h2>
            ...
            <div class="text-md text-center mt-6 text-gray-500">
                <span>Don't have an account? </span><a href="member-signup.jsp" class="hover:underline text-blue-600 font-medium">Sign Up Now</a>
            </div>
        </div>
    </div>
