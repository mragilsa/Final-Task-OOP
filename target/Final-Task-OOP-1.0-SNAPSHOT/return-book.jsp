...
<body class="bg-gray-100 text-gray-800">
    ...
    <main class="container mx-auto px-6 py-6">
        <h2 class="text-3xl font-semibold mb-8 text-center text-gray-800">Return Book Page</h2>
                ...
                <table class="min-w-full table-auto border border-gray-200 rounded-xl overflow-hidden shadow">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                            ...
                            if (borrowedBooks != null && !borrowedBooks.isEmpty()) {
                                for (Transaction t : borrowedBooks) {
                                    ...
                                    if (daysBetween > t.getDuration()) {
                                        fine = (daysBetween - t.getDuration()) * 2; 
                                    }
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4"><%= fineStatus %></td>
                            <td class="px-6 py-4">
                                <a href="return-book?action=return&transactionId=<%= t.getTransactionId() %>&bookId=<%= t.getBookId() %>"
                        ...
                        %>
                        <tr>
                            <td colspan="7" class="text-center px-6 py-4 text-gray-500">There are no books currently on loan.</td>
                        </tr>
                        <% } %>
                    </tbody>
                </table>
